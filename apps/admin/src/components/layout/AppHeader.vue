...
<template>
  <header class="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6">
    ...
    <div class="flex items-center gap-3">
      ...
      >
        <svg v-if="uiStore.darkMode" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
      ...
      <div class="relative">
        ...
        >
          ...
          <div v-if="user" class="hidden text-left sm:block">
        ...
        <Transition name="fade">
          <div
            v-if="showUserMenu"
            class="absolute right-0 top-full z-20 mt-1 w-56 rounded-xl border border-gray-200 bg-white py-1 shadow-lg"
          >
        ...
        <div v-if="showUserMenu" class="fixed inset-0 z-10" @click="closeMenu" />
      </div>
    </div>
  </header>
</template>
